...
const Svg4 = props => (
  <Svg width={255} height={335} viewBox="0 0 102 134" {...props}>
    ...
    <Circle r={7} fill="#67eaca" transform="translate(41 77)" />
    <Circle r={7} fill="#67eaca" transform="translate(61 57)" />
    <Circle r={7} fill="#67eaca" transform="translate(81 77)" />
    <G
      textAnchor="middle"
      fill="#12d3cf"
      fontSize={9}
      fontFamily="Oswald-Regular"
    >
      <Text transform="translate(21 122)">{"F"}</Text>
